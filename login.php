...
<div class="login-box ">
  <div class="login-logo">
    <a href="#"><b>Travel Order</b> <br>Monitoring System</a>
  </div>
  <!-- /.login-logo -->
...
<?php 
  if(isset($_GET['error'])){
    ...
    echo "<span class='alert alert-danger col-md-12 '>Login Failed: Credentials do not match our records.</span>";
  }
?>
