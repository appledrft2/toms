  ...
  <table border="0" style="width: 100%;">
    ...
    <tbody>
      <?php 
        ...
        $qry->bind_param('i',$_GET['id']);
        $qry->execute();
        $qry->bind_result($id,$s_tv_id,$placestovisit,$departure,$arrival,$meansoftravel,$allowed,$total);
        $qry->store_result();
        $cnt=0;
        $sum = 0;
        while($qry->fetch ()) {
      ...
      <tr>
        <td colspan="8" style="width: 99.8279%;"><br>&nbsp;&nbsp;&nbsp;I certify that (1) I have reviewed the forgoing<br>
          ...
          <div style="text-align: right">
            <br><u ><span style="text-transform: uppercase;"><?php echo $dbf." ".$dbl; ?></u>
